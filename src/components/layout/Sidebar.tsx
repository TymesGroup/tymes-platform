/**
 * Sidebar Component - Apple-inspired Floating Design
  ...
  return (
    <>
        ...
        >
          ...
          <div className={`${collapsed ? 'px-3 py-2' : 'px-4 py-3'} relative`}>
            ...
            {showAccountSwitcher && !collapsed && (
              <div className="absolute top-full left-4 right-4 mt-2 bg-white dark:bg-[#2d2d2d] rounded-xl shadow-xl border border-[#d2d2d7] dark:border-[#424245] overflow-hidden z-50">
                ...
                <div className="p-2 border-t border-[#d2d2d7] dark:border-[#424245]">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 p-2.5 text-[13px] font-medium text-[#0066cc] hover:bg-[#f5f5f7] dark:hover:bg-[#3d3d3d] rounded-lg transition-colors"
                  >
                    <UserPlus size={16} />
                    Adicionar conta
                  </button>
          ...
          {!isSuperAdmin && !isRootModule && !collapsed && (
            <div className="px-4 mb-2">
              <div className="p-3 bg-[#f5f5f7] dark:bg-[#2d2d2d] rounded-xl">
                <button
          ...
          {!isSuperAdmin && !isRootModule && collapsed && (
            <div className="px-3 mb-2">
              <button
                onClick={() => onNavigate(ModuleType.EXPLORE)}
                className="w-full p-2.5 rounded-xl bg-[#f5f5f7] dark:bg-[#2d2d2d] text-[#0066cc] flex justify-center"
              >
                <ArrowLeft size={18} />
              </button>
            </div>
          ...
          <nav className={`flex-1 ${collapsed ? 'px-3' : 'px-4'} space-y-1 overflow-y-auto`}>
                ...
                <button
                  ...
                  className={`w-full flex items-center ${collapsed ? 'justify-center p-2.5' : 'gap-3 px-3 py-2.5'} rounded-xl text-[14px] transition-colors ${
                    activePage === item.id
                      ...
                      : 'text-[#1d1d1f] dark:text-[#f5f5f7] hover:bg-[#f5f5f7] dark:hover:bg-[#2d2d2d]'
                  }`}
                >
                  <item.icon size={18} />
              ...
              navItemsToRender.map(item => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center ${collapsed ? 'justify-center p-2.5' : 'gap-3 px-3 py-2.5'} rounded-xl text-[14px] transition-colors ${
                      isActive
                        ? 'bg-[#f5f5f7] dark:bg-[#2d2d2d] text-[#0066cc] font-medium'
                        : 'text-[#1d1d1f] dark:text-[#f5f5f7] hover:bg-[#f5f5f7] dark:hover:bg-[#2d2d2d]'
                    }`}
                  >
                    <Icon size={18} />
            ...
            {!isSuperAdmin &&
              ...
              currentModuleMenu?.items
                .filter(
                  item => !item.allowedProfiles || item.allowedProfiles.includes(activeProfile)
                )
                .map(item => (
                  <button
                    key={item.id}
          ...
          {/* Bottom Actions */}
          <div className={`${collapsed ? 'p-3' : 'p-4'} space-y-1`}>
            {!isSuperAdmin && (
              <button
            ...
            <button
              ...
              className={`w-full flex items-center ${collapsed ? 'justify-center p-2.5' : 'gap-3 px-3 py-2.5'} rounded-xl text-[14px] text-[#1d1d1f] dark:text-[#f5f5f7] hover:bg-[#f5f5f7] dark:hover:bg-[#2d2d2d] transition-colors`}
            >
      ...
      {showAccountModal && (
        ...
        >
          <div
            className="bg-white dark:bg-[#1d1d1f] rounded-2xl shadow-2xl max-w-[360px] w-full"
